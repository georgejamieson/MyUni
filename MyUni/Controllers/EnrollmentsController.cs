...
namespace MyUni.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,StudentID,CourseID,EnrollmentDate,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentID,StudentID,CourseID,EnrollmentDate,Grade")] Enrollment enrollment)
        {
